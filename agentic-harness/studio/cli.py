...
def cmd_run(args: argparse.Namespace) -> int:
    cfg = _load(args)
    executor, tracker, registry, runtimes = _world(cfg)
    orch = Orchestrator(cfg, tracker, registry, runtimes, executor=executor)
    if args.watch:
